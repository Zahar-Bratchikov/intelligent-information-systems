;; ============================================================================
;; ЭКСПЕРТНАЯ СИСТЕМА РЕКОМЕНДАЦИЙ ПУТЕШЕСТВИЙ (ИСПРАВЛЕННАЯ ВЕРСИЯ)
;; ============================================================================
;; Версия: 2.0
;; Язык: CLIPS 6.3+
;; Описание: Система анализирует предпочтения пользователя и рекомендует
;;           оптимальное направление для путешествия на основе бюджета,
;;           здоровья, желаемого типа отдыха и других факторов.
;;
;; ИНСТРУКЦИЯ ПО ЗАПУСКУ:
;; ----------------------
;; 1. Запустите CLIPS
;; 2. Выполните команды в следующей последовательности:
;;    CLIPS> (clear)
;;    CLIPS> (load "travel.clp")
;;    CLIPS> (reset)     ; Команда reset подставляет факты из deffacts
;;    CLIPS> (run)
;;
;; После выполнения (run) система запросит у вас данные интерактивно,
;; выведет процесс логического вывода и итоговую рекомендацию.
;;
;; Для просмотра всех фактов в базе знаний после завершения:
;;    CLIPS> (facts)
;; ============================================================================
...
;; ============================================================================
;; РАЗДЕЛ 9: ФИНАЛЬНЫЕ РЕКОМЕНДАЦИИ (ПРАВИЛА 18-30)
;; ============================================================================
